...
import TenantUnitPage from '../pages/tenant/unit/UnitPage';
import TenantLayout from '../layouts/TenantLayout';
import TenantPaymentPage from '../pages/tenant/payments/PaymentPage';
import TenantMaintenancePage from '../pages/tenant/maintenance/MaintenancePage';
            ...
            <Routes>
                ...
                <Route element={<ProtectedRoute role="TENANT" />}>
                    <Route element={<TenantLayout />}>
                        <Route path={ROUTES.TENANT.UNIT} element={<TenantUnitPage />} />
                        <Route path={ROUTES.TENANT.PAYMENTS} element={<TenantPaymentPage />} />
                        <Route path={ROUTES.TENANT.MAINTENANCE} element={<TenantMaintenancePage />} />
                    </Route>
                </Route>
            </Routes>
        </BrowserRouter>
